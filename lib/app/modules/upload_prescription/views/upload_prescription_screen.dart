...
class UploadPrescriptionScreeen extends GetView<UploadPrescriptionController> {
  const UploadPrescriptionScreeen({Key? key}) : super(key: key);
  @override
        ...
        child: SingleChildScrollView(
          child: Form(
            ...
            child: Column(
              ...
              children: [
                "Upload Prescription".text.size(18).bold.make(),
                5.heightBox,
